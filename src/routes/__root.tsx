...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rapeda — Industrial Print Technology" },
      { name: "description", content: "Industrial UV, DTF and heat press systems built for production." },
      { name: "author", content: "Rapeda" },
      { property: "og:site_name", content: "Rapeda" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },

      { property: "og:title", content: "Rapeda — Industrial Print Technology" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500;600;700;800;900&family=Inter:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
